...
@section('content')
    <div class="flex flex-col justify-center items-center space-x-4 space-y-4 mx-auto">
        ...
        @endif
        <form class="space-y-6 w-full md:w-1/2" action="{{ route('user.timesheet.edit.store', $timesheet->id) }}"
            method="POST">
            @method('put')
            @csrf
            <div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <div class="relative w-full">
                        ...
                        <input datepicker type="text" datepicker-format="yyyy-mm-dd" value="{{ $timesheet->date }}"
                            name="date"
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <input type="time" id="start_time" name="start_time"
                            value="{{ \Carbon\Carbon::parse($timesheet->time_start)->format('H:i') }}"
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <input type="time"id="end_time" name="end_time"
                            value="{{ \Carbon\Carbon::parse($timesheet->time_end)->format('H:i') }}"
                            class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            min="00:00" max="23:59" required />
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <textarea id="summary_of_work" name="summary_of_work" rows="10"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2">{{ $timesheet->summary_of_work }} </textarea>
                </div>
            </div>
